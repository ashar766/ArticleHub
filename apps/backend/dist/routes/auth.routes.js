...
import { SignupSchema, LoginSchema, ForgotPasswordSchema, ResetPasswordSchema, } from "@articlehub/shared";
...
router.get("/profile", authenticate, asyncHandler(authController.profile.bind(authController)));
